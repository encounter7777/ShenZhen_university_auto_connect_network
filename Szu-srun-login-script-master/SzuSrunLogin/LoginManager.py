...
class LoginManager:
    def __init__(
        self,
        url_login_page="http://net.szu.edu.cn/srun_portal_pc?ac_id=2&theme=pro",
        url_get_challenge_api="http://net.szu.edu.cn/cgi-bin/get_challenge",
        url_login_api="http://net.szu.edu.cn/cgi-bin/srun_portal",
        n="200",
        vtype="1",
        acid="1",
        enc="srun_bx1",
    ...
    def get_ip(self):
        ...
        self._resolve_acid_from_login_page()
    ...
    @infomanage(
        callinfo="Resolving acid from login page html",
        successinfo="Successfully resolve acid",
